...
def check_prompt(prompt_template: str, transcript_text: str, stream: bool = False):
    """Отправляет промпт на проверку без системного промпта и возвращает сырой текст или стример."""
    start_time = time.time()
